...
namespace Persistence.Migrations
{
    ...
    [Migration("20200506231830_ActualizarEntidades")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Domain.Documents", b =>
                {
                    ...
                    b.ToTable("Documents","auth");
                });

            modelBuilder.Entity("Core.Domain.Empresas", b =>
                {
            ...
            modelBuilder.Entity("Core.Domain.TiposDeEmpresas", b =>
                {
                    b.Property<int>("TipoEmpresaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("TipoEmpresaNombre")
                        .HasColumnType("int")
                        .HasMaxLength(80);
            ...
            modelBuilder.Entity("Core.Domain.Empresas", b =>
                {
                    b.HasOne("Core.Domain.TiposDeEmpresas", "TipoEmpresa")
                        .WithMany("Empresas")
